---
title: "Git 同步上游仓库的更新"  # 文章标题
pubDate: 2025-04-04        # 发布时间（Date格式）
updatedDate: 2025-04-04    # 更新时间（可选）
tags:                       # 标签数组
  - "Git"
  - "教程"
description: "如何同步上游仓库的更新到你的本地仓库。"  # 摘要
cover: "https://i1.wp.com/dev.ruom.top/i/2025/04/07/995956.webp"  # 封面图路径（可选）
---
