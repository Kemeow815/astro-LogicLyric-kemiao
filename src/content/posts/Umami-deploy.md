---
title: "Umami博客访问统计Vercel+Cloudflare Wokers部署"  # 文章标题
pubDate: 2025-04-06        # 发布时间（Date格式）
updatedDate: 2025-04-07    # 更新时间（可选）
tags:                       # 标签数组
  - "Umami"
  - "网站统计"
description: "Umami博客访问统计Vercel+Cloudflare Wokers部署教程。"  # 摘要
cover: "https://i1.wp.com/dev.ruom.top/i/2025/04/07/951842.webp"  # 封面图路径（可选）
---
