---
title: "tgtalk免费部署"  # 文章标题
pubDate: 2025-05-04        # 发布时间（Date格式）
updatedDate: 2025-05-04   # 更新时间（可选）
tags:                       # 标签数组
  - "tgtalk"
  - "说说"
description: "一个基于 Cloudflare Workers 的 tg 频道消息说说。"  # 摘要
cover: "https://cdn.jsdelivr.net/gh/kmfx/tuchuang@main/img/202505051857682.webp"  # 封面图路径（可选）
---
